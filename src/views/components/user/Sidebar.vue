<template>
  <div>
   <div class="sidenav" id="user-sidenav">
     ...
     <router-link v-if="$can('osa_permissions')" to="/user/osa/archived" class="w-100"><i class="bi bi-archive me-2 bi-2x"></i><span class="sidenav-sr">Deleted Post</span></router-link>
