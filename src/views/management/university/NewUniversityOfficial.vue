        ...
        <div class="col-12 col-sm-12 col-md-11 col-lg-11 col-xl-12">
          <div class="card p-5 mb-4">
                ...
                <p class="mt-3">Personal Information</p>
                  <div class="col-11 col-sm-11 col-md-5 col-lg-5 col-xl-4">
                    <div class="">
                      ...
                      <input v-model="data.first_name" type="text" class="form-control" id="firstname" placeholder="">
                  ...
                  <div class="col-11 col-sm-11 col-md-5 col-lg-5 col-xl-4">
                    <div class="">
                      ...
                      <input v-model="data.telephone" type="text" class="form-control" id="contactnumber" placeholder="">
                    </div>
                  </div>
                  <div class="col-11 col-sm-11 col-md-5 col-lg-5 col-xl-4">
                    <div class="">
                      <label for="text-muted "><small>Select Gender</small></label>
                      <select v-model="data.gender" class="form-select" id="genderSelect" aria-label="Select gender">
                 ...
                 <div class="col-11 col-sm-11 col-md-5 col-lg-5 col-xl-4">
                    <div class="">
                      ...
                      <input v-model="data.role" type="text" class="form-control" id="role" placeholder="">
                      <div class="invalid-feedback">
                        Role is required
                      </div>
                    </div>
                 ...
                 <div class="col-11 col-sm-11 col-md-5 col-lg-5 col-xl-4">
                    <div class="">
                      ...
                      <input v-model="data.title" type="text" class="form-control" id="title" placeholder="">
                    </div>
                 </div>
                 <div class="col-11 col-sm-11 col-md-5 col-lg-5 col-xl-4">
                    <div class="">
            ...
            <div v-if="!initialLoading"  class="d-flex mt-4">
              <button :disabled="isLoading" v-on:click.prevent="saveOfficial" class="btn btn-purple me-2">
...
export default {
  ...
  async mounted(){
    document.title = 'New School Official'
  ...
  methods: {
   filesSelected: function(fileRecordsNewlySelected) {
    ...
    async saveOfficial(){
     ...
     if(this.data.role == '') return this.$toast.error('Role is required');
      ...
      const res = await this.$store.dispatch('universityinfo/saveOfficial', this.data)
      if(res.status == 200){
        this.$router.push('/home/universityinfo')
        this.$toast.success('School Official created successfully!')
