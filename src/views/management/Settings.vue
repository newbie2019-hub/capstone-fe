     ...
     <div class="col-11 col-md-6 col-lg-6 col-xl-6">
      ...
      <hr class="mt-2 mb-2"/>   
        <div class="d-flex justify-content-center mt-2">
          <b-avatar variant="secondary" v-if="user.admininfo.image" :src="`${imgURL}/${user.admininfo.image}`" size="12rem"></b-avatar>
  ...
  <b-modal id="changePasswordModal" hide-footer centered title="Change Password">
    <b-form @submit.prevent="changePassword">
      ...
      <div class="d-flex justify-content-end">
        <b-button variant="primary" class="me-2" @click="$bvModal.hide('changePasswordModal')" :disabled="isLoading"> Cancel </b-button>
  ...
  methods: {
   ...
   async saveChanges(){
    ...
    if(res.status == 200){
      ...
      this.fileRecordsForUpload = null
